# Coursera Exploratory Data Analysis Exercise 2

This repository contains all files required to run the exercise answering follwing questions:
...
Each above questions can be answered by sourcing associated R script **plot#.R** which will create an associated PNG plot file **plot#.png**. 
